    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item active">
          <a class="nav-link " href="#" data-toggle="collapse" data-target="#collapseBlog" aria-expanded="true" aria-controls="collapseBlog">
          ...
          <div id="collapseBlog" class="collapse show" aria-labelledby="headingBlog" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active" href="add_blog.php">Add Blog</a>
        ...
        <div class="container-fluid">
          <nav>
            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
              <a class="nav-item nav-link active" id="nav-summary-tab" data-toggle="tab" href="#nav-summary" role="tab" aria-controls="nav-summary" aria-selected="true"> Add Your Blog Contents</a>
            </div>
          </nav>
          <?php
          if(isset($error)){
          ...
          <form method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?> " >
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="post_title" name="post_title" placeholder="Enter your post title">
            </div>



                         <!--  <div class="form-group">
                            <label for="blog_posted_on">Posted on</label>
                            <input type="text" class="form-control" id="blog_posted_on" name="blog_posted_on" placeholder="Enter your Profession">
                          </div> -->

                          <div class="form-group">
                            <label for="upload_image">Upload Image</label>
                            <input type="file" class="form-control" id="upload_image" name="upload_image" placeholder="">
                          </div> 

                          <?php if ($imageerrors==2): ?>
                            <div class="alert alert-danger">
                              <li><?php echo 'Please Select any Image!' ?></li>
                            </div>
                          <?php endif; ?>


                          <div class="form-group">
                            <label for="post_content">Write Your Blog Content</label>
                            <textarea class="ckeditor" id="post_content" name="post_content" rows="3" placeholder="Enter your post title"></textarea>
                          </div>


                          <div class="form-group">
                            <label for="blog_blockquote">Blog Blockquote Footer </label>
                            <input type="text" class="form-control" id="blog_blockquote" name="blog_blockquote" placeholder="Enter your website address">
                          </div>
                       <!--    <div class="form-group">
                            <label for="degree">Footer</label>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="source_title" name="source_title" placeholder="Enter your phone number">
                          </div>
                ...
                <!--           <div class="form-group">
                          ...
                          <button type="submit" name="blog-add-btn" class="btn btn-primary">Save</button>
                        </form>
                        <!-- /end of input form -->
                      </div>
