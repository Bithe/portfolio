  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseSM" aria-expanded="true" aria-controls="collapseSM">
          <i class="fas fa-fw fa-folder"></i>
          <span>Social Media</span>
        </a>

        <div id="collapseSM" class="collapse show" aria-labelledby="headingSM" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">

              <div class="collapse-divider"></div>
        
              <h6 class="collapse-header">About Social Media:</h6>

              <a class="collapse-item active" href="add_social_media.php">Add Social Media</a>
              <a class="collapse-item" href="edit_about.php">Edit About</a>
        ...
        <div class="container-fluid">
          <nav>
            <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
              <a class="nav-item nav-link active" id="nav-summary-tab" data-toggle="tab" href="#nav-summary" role="tab" aria-controls="nav-summary" aria-selected="true"> Add About You</a>
            </div>
          </nav>
          <?php
          if(isset($error)){
          ...
          <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="twitter" name="twitter" rows="3" placeholder="Enter your twitter id link">
            </div>

            <div class="form-group">
              <label for="facebook">Facebook</label>
              <input type="text" class="form-control" name="facebook" id="facebook" placeholder="Enter your facebook id link">
            </div>

            <div class="form-group">
              <label for="instragram">Instragram</label>
              <input type="text" class="form-control" id="instragram" name="instragram" placeholder="Enter your instragram id link">
            </div>

            <div class="form-group">
              <label for="skype">Skype</label>
              <input type="number" class="form-control" id="skype" name="skype" placeholder="Enter your skype id link">
            </div>

            <div class="form-group">
              <label for="linkdin">Linkdin</label>
              <input type="text" class="form-control" id="linkdin" name="deglinkdinree" placeholder="Enter your linkdin id link">
            </div>

            <button type="submit" name="social-save-btn" class="btn btn-primary">Save</button>
          </form>
          <!-- /end of input form -->
        </div>
