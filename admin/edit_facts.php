      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="edit_facts.php">Edit Facts</a>
        ...
        <div class="container-fluid">
             ...
             <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                      <a class="nav-item nav-link active" id="nav-summary-tab" data-toggle="tab" href="#nav-summary" role="tab" aria-controls="nav-summary" aria-selected="true"> Edit Fatcs</a>
                    </div>
                </nav>
         ...
         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
              ...
              <div class="form-group">
                  ...
                  <textarea class="form-control" id="description" rows="3" name="facts_description"><?php echo $facts_description ?> </textarea>
              </div>


              <div class="form-group">
                  <label for="clients">Clients</label>
                  <input type="number" class="form-control" name="facts_clients" id="facts_clients" value="<?php echo $facts_clients ?>">
              </div>

              <div class="form-group">
                  <label for="projects">Projects</label>
                  <input type="number" class="form-control" name="facts_projects" id="facts_projects" value="<?php echo $facts_projects ?>">
              </div>

              <div class="form-group">
                  <label for="support">Hours Of Support</label>
                  <input type="number" class="form-control" name="facts_support" id="facts_support" value="<?php echo $facts_support ?>">
              </div>

              <div class="form-group">
                  <label for="workers">Hard workers</label>
                  <input type="number" class="form-control" name="facts_workers" id="facts_workers" value="<?php echo $facts_workers ?>">
              </div>



               <button type="submit" class="btn btn-primary" name="facts-edit-btn">Update</button>
