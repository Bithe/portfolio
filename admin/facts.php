      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="facts.php">Add facts</a>
        ...
        <div class="container-fluid">
             ...
             <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                      <a class="nav-item nav-link active" id="nav-summary-tab" data-toggle="tab" href="#nav-summary" role="tab" aria-controls="nav-summary" aria-selected="true"> Add Facts</a>
                    </div>
                </nav>
         ...
         <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
              ...
              <div class="form-group">
                  <label for="facts_description">Description</label>
                  <textarea class="form-control" id="facts_description" rows="3" name="facts_description" placeholder="Enter your Facts description"></textarea>
              </div>


              <div class="form-group">
                  <label for="facts_clients">Clients</label>
                  <input type="number" class="form-control" id="facts_clients" name="facts_clients" placeholder="Enter your clients number">
              </div>

              <div class="form-group">
                  <label for="facts_projects">Projects</label>
                  <input type="number" class="form-control" id="facts_projects" name="facts_projects" placeholder="Enter your clients number">
              </div>

              <div class="form-group">
                  <label for="facts_support">Hours Of Support</label>
                  <input type="number" class="form-control" id="facts_support"  name="facts_support" placeholder="Enter your hours of Support number">
              </div>

              <div class="form-group">
                  <label for="facts_workers">Hard workers</label>
                  <input type="number" class="form-control" id="facts_workers" name="facts_workers" placeholder="Enter your hard workers number">
              </div>



               <button type="submit" class="btn btn-primary" name="facts-add-btn">Submit</button>
