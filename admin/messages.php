                  ...
                  ?>
                      ...
                      <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                          ...
                          <div class="form-group">
                                ...
                                <textarea class="form-control" id="about_u" name="about_u" rows="3" placeholder="Enter about yourself"></textarea>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="birthday" name="birthday" placeholder="Enter your Birth Date">
                          </div>
                          <div class="form-group">
                          ...
                          <button type="submit" name="about-save-btn" class="btn btn-primary">Save</button>
                        </form>
                        <!-- /end of input form -->
                    </div>
